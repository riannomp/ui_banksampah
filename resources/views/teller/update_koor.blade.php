<div id="updatekoor{{ $koor->id_koor }}" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('updateKoorTeller') }}" method="POST" class="parsley-examples"
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <textarea type="text" class="form-control" id="edit_alamat" name="edit_alamat">{{ $koor->alamat }}</textarea>
                            </div>
                        </div>
